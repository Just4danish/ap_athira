...
import {
  cardCategoriesList,
  InspectionCardCategoriesList,
} from '../components/InspectorSearch/searchInCategoriesList';
...
export default function EntityInspectionsPage1() {
  ...
  return (
    <ScrollView
      ...
      {entityInfo &&
        inspectorContext.selectedEntity &&
        InspectionCardCategoriesList.map((item, index) => (
          <View
            key={index}
            style={{
              width: '90%',
